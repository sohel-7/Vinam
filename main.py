...
TOKEN = '7240194618:AAGs0ezAbyPiqfiLBhWbb-5mum7qsRmnMNg'
bot = telebot.TeleBot(TOKEN, threaded=False)

# 🛡️ List of authorized user IDs (replace with actual IDs)
AUTHORIZED_USERS = [1662672529,6654576379]

# 🌐 Global dictionary to keep track of user attacks
user_attacks = {6654576379}
...
def start(message):
    ...
    if user_id not in AUTHORIZED_USERS:
        bot.send_message(message.chat.id, "🚫 Access Denied! Contact the owner for assistance: @GODNEXTYT")
    else:
        welcome_message = (
            ...
            "📞 Contact the owner on Instagram and Telegram: @GODNEXTYT\n"
...
def owner(message):
    ...
    bot.send_message(message.chat.id, "📞 Contact the owner: @GODNEXTYT")
...
This bot is owned and operated by @GODNEXTYT on Telegram and all4outgaming on Instagram, 🇮🇳. By using this bot, you acknowledge that you understand and agree to the following terms:
...
* **🤝 INDEMNIFICATION**: You agree to indemnify and hold harmless @GODNEXTYT on Telegram and venomXcrazy, and its affiliates, officers, agents, and employees, from and against any and all claims, damages, obligations, losses, liabilities, costs or debt, and expenses (including but not limited to attorney's fees) arising from or related to your use of this bot.
* **🌐 THIRD-PARTY LINKS**: This bot may contain links to third-party websites or services, and you acknowledge that @GODNEXTYT on Telegram and all4outgaming on Instagram is not responsible for the content, accuracy, or opinions expressed on such websites or services.
* **🔄 MODIFICATION AND DISCONTINUATION**: You agree that @GODNEXTYT on Telegram may modify or discontinue this bot at any time, without notice, and that you will not be entitled to any compensation or reimbursement for any losses or damages arising from such modification or discontinuation.
...
if __name__ == "__main__":
    ...
    print(" 👍 Bot is now online with @GODNEXTYT Script and ready to Ddos_attack! ▰▱▰▱▰▱▰▱▰▱▰▱▰▱")
